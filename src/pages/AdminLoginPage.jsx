            ...
            <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
              <div className="p-4 sm:p-8">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        name="password"
                        placeholder="••••••••"
                        className={`w-full px-3 sm:px-4 py-2 sm:py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition pr-10 sm:pr-12 text-sm sm:text-base ${
                  ...
                  <div className="bg-blue-50 border border-blue-100 rounded-lg p-3 sm:p-4">
                    <div className="flex items-start gap-2">
                      <p className="text-xs sm:text-sm text-blue-700">
                        <strong>Keamanan:</strong> Hanya panitia yang berwenang
                  ...
                  >
                    {loading ? (
                      ...
                      <>
                        ...
                        <span className="sm:hidden">Masuk ke Admin</span>
                ...
                <div className="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-gray-200">
                  <button
                    onClick={() => navigate('/')}
                    className="text-blue-600 hover:text-blue-800 font-medium w-full text-center text-sm sm:text-base"
                  >
